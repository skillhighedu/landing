...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="Interface-Essential-List--Streamline-Pixel"  fill="currentColor" className={`w-5 cursor-pointer text-white  h-5 ${props.className ?? ""}`}>
