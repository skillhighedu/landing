...
import { Calendar, MessageSquare, X, Sparkles, ArrowRight } from 'lucide-react';
...
export default function Popup() {
  ...
  const checkPopup = () => {
    ...
    if (!lastClosed || now - Number(lastClosed) > POPUP_INTERVAL_MINUTES * 60 * 1000) {
      setOpen(true);
    }
  };
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            {/* Accent Badge */}
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 py-1 border border-primary/30">
            ...
            <button
              onClick={closePopup}
              className="absolute right-3 top-3 p-2 rounded-md text-neutral-400 hover:text-white hover:bg-neutral-800 transition"
              aria-label="Close"
            >
              <X size={18} />
            </button>
            ...
            <div className="space-y-4 mb-7">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-white">30-minute call</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm  text-white">1-on-1 guidance</p>
                  <p className="text-xs text-neutral-500">
